...
using TestCenterController.Services;

namespace TestCenterController
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                var agentUrl = Environment.GetEnvironmentVariable("TEST_CENTER_AGENT_HOST");
                var port = 8021;
                ...
                c.DefaultRequestHeaders.Add("User-Agent", "TestCenterController");
            });
